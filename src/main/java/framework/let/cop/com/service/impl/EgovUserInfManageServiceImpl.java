...
import framework.let.cop.com.service.EgovUserInfManageService;
import framework.let.cop.com.service.UserInfVO;
...
public class EgovUserInfManageServiceImpl extends EgovAbstractServiceImpl implements EgovUserInfManageService {
     ...
     * 동호회 운영자 목록을 조회한다.
     * 
     * @see framework.let.cop.com.service.EgovUserInfManageService#selectClubOprtrList(framework.let.cop.com.service.UserInfVO)
     */
     ...
     * 동호회 사용자 목록을 조회한다.
     * 
     * @see framework.let.cop.com.service.EgovUserInfManageService#selectClubUserList(framework.let.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 관리자 목록을 조회한다.
     * 
     * @see framework.let.cop.com.service.EgovUserInfManageService#selectCmmntyMngrList(framework.let.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 사용자 목록을 조회한다.
     * 
     * @see framework.let.cop.com.service.EgovUserInfManageService#selectCmmntyUserList(framework.let.cop.com.service.UserInfVO)
     */
     ...
     * 사용자 정보에 대한 목록을 조회한다.
     * 
     * @see framework.let.cop.com.service.EgovUserInfManageService#selectUserList(framework.let.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see framework.let.cop.com.service.EgovUserInfManageService#selectAllClubUser(framework.let.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see framework.let.cop.com.service.EgovUserInfManageService#selectAllCmmntyUser(framework.let.cop.com.service.UserInfVO)
     */
