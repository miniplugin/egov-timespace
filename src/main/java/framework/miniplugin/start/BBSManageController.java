package framework.miniplugin.start;
...
import framework.com.cmm.EgovMessageSource;
import framework.com.cmm.LoginVO;
import framework.com.cmm.service.EgovFileMngService;
import framework.com.cmm.service.EgovFileMngUtil;
import framework.com.cmm.service.FileVO;
import framework.com.cmm.util.EgovUserDetailsHelper;
import framework.let.cop.bbs.service.Board;
import framework.let.cop.bbs.service.BoardMaster;
import framework.let.cop.bbs.service.BoardMasterVO;
import framework.let.cop.bbs.service.BoardVO;
import framework.let.cop.bbs.service.EgovBBSAttributeManageService;
import framework.let.cop.bbs.service.EgovBBSManageService;
import framework.miniplugin.com.DoubleSubmitHelper;
...
public class BBSManageController {
	...
	if (master.getTmplatCours() == null || master.getTmplatCours().equals("")) {
	    master.setTmplatCours("/css/framework/cop/bbs/egovBaseTemplate.css");
	}
	////-----------------------------
    ...
    public String selectBoardArticle(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		if (masterVo.getTmplatCours() == null || masterVo.getTmplatCours().equals("")) {
		    masterVo.setTmplatCours("/css/framework/cop/bbs/egovBaseTemplate.css");
		}
	...
	if (bdMstr.getTmplatCours() == null || bdMstr.getTmplatCours().equals("")) {
	    bdMstr.setTmplatCours("/css/framework/cop/bbs/egovBaseTemplate.css");
	}
	...
	if (bmvo.getTmplatCours() == null || bmvo.getTmplatCours().equals("")) {
	    bmvo.setTmplatCours("/css/framework/cop/bbs/egovBaseTemplate.css");
	}
